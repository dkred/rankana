                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                                <a href="{{route('productos.index')}}"
                                    ...
                                    <p>
                                        Productos
                                        <?php use App\Producto; $producto_count = Producto::all()->count(); ?>
                             ...
                             <li class="nav-item">
                                <a href="{{route('artistas.index')}}"
                                    ...
                                    <p>
                                        Artistas
                                        <?php use App\Artista; $artista_count = Artista::all()->count(); ?>
                                        <span class="right badge badge-danger">{{ $artista_count ?? '0' }}</span>
                                    </p>
                                </a>
                            </li>
                             <li class="nav-item">
